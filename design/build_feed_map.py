...
function render(){
  ...
  // 카드 피드
  feed.innerHTML='<div class="feedhead"><div class="fh-top"><b>오늘의 발견</b><span>서울 출발 · '+vis.length+'곳</span></div>'+
    '<div class="sortbar">'+
  ...
  for(var s=0;s<sps.length;s++){(function(el){el.addEventListener('click',function(){sortMode=el.dataset.sort;clearHi();render();});})(sps[s]);}
