...
BOXES = {
    ...
    # ── 확정 (2026-09-01): 검색 바 + 날짜·예산 알약 ──
    "FIN": (16, SH - 66, SW - 16, SH - 14),   # 52px
}

DOCK_H = {"G0": 90, "G1": 44, "G2": 52, "G3": 44, "FIN": 52}
...
def dock_html(kind):
    # ── 확정안 (2026-09-01) ────────────────────────────────────
    # 검색 한 줄이 주인공. 날짜·예산은 값이 "범위"라 타이핑으로 고르기 나빠
    # 오른쪽 알약 + 팝오버로 뺐다.
    if kind == "FIN":
        return ('<div class="bar h52">'
                '<span class="srch"><span class="mag">&#9906;</span>'
                '<span class="ph">어디로 갈까요? &nbsp;해변 · 야경 · 온천 · 다낭&hellip;</span></span>'
                '<span class="sep"></span>'
