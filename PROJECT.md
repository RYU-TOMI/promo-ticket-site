...
- 신선도 배지 확정 시각: `design/freshness.html`(2026-08-22).
...
- [x] **신선도 배지**: `seen`(소스 관측 시각) 기준 3등급(fresh<24h·ok<72h·stale>72h), 가격 라벨 치환,
  hero는 fresh에서만, 하드 컷 7일. 정렬·필터·핀에는 미반영(2026-08-22, DESIGN.md/DECISIONS.md, `design/freshness.html`).
  → **계약 변경(`seen` 필드 추가)이라 백엔드 세션 전달 필요.**
